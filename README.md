...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 3146ab4f-adac-425b-8802-27fda1ad29ef
```

> `3146ab4f-adac-425b-8802-27fda1ad29ef` is the password of the certificate, you can change it to any password you want.
